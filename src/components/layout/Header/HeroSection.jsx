    ...
    <div className=" py-8 mt-16 md:mt-0 px-5 md:px-10 md:grid md:gap-x-3 md:grid-cols-2  md:items-center md:justify-between md:h-screen">
      <div className="pb-5">
        ...
        <div className="flex justify-center gap-x-2 md:justify-start">
          <button className="flex items-center justify-center bg-clr4 px-7 py-5 rounded-lg text-white">
            Show Here <FaArrowCircleRight className="text-clr3 ml-1" />
          </button>
          <button className="flex items-center justify-center px-7 py-5 rounded-lg text-black font-semibold shadow-sm shadow-black">
